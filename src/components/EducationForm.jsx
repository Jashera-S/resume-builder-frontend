  ...
  return (
    <div className='space-y-6'>
      <div className='flex items-center justify-between'>
        ...
        <button onClick={addEducation} className='flex items-center gap-2 px-3 py-1 text-sm bg-[#660099]/10 text-[#660099] rounded-lg hover:bg-[#660099]/20 transition-colors'>
